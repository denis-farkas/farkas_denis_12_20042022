  ...
  return (
    <div className="aside">
      <div className="cel col-lg-12">
        <div className="row">
          <div className="calories rect-icon col-lg-3">
            <svg
              width="17"
              height="20"
              viewBox="0 0 17 20"
          ...
          <div className="avg col-lg-9">
            <h6>
              {user && numberWithCommas(user.data.keyData.calorieCount)}kCal
            </h6>
            <p>Calories</p>
          </div>
        </div>
      ...
      <div className="cel col-lg-12">
        <div className="row">
          <div className="proteines rect-icon col-lg-4">
            <svg
              width="19"
              height="19"
              viewBox="0 0 19 19"
          ...
          <div className="avg col-lg-8">
            <h6>{user && numberWithCommas(user.data.keyData.proteinCount)}g</h6>
            <p>Proteines</p>
          </div>
        </div>
      </div>
      <div className="cel col-lg-12">
        <div className="row">
          <div className="glucides rect-icon col-lg-4">
            <svg
              width="18"
              height="20"
              viewBox="0 0 18 20"
          ...
          <div className="avg col-lg-8">
            <h6>
              {user && numberWithCommas(user.data.keyData.carbohydrateCount)}g
            </h6>
            <p>Glucides</p>
          </div>
        </div>
      ...
      <div className="cel col-lg-12">
        <div className="lipides rect-icon col-lg-4">
          <svg
            width="20"
            height="19"
            viewBox="0 0 20 19"
        ...
        <div className="avg col-lg-8">
          <h6>{user && numberWithCommas(user.data.keyData.lipidCount)}g</h6>
          <p>Lipides</p>
        </div>
      </div>
    </div>
